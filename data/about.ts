...
export const ABOUT_DATA = {
  festOverview: {
    title: "ABOUT INNOVEX '26",
    tagline: "WHERE KALAHANDI'S COGNITIVE ENERGY MEETS NATIONAL SCALE INNOVATION",
    paragraphs: [
      "INNOVEX '26 is the signature national-level annual technology and engineering festival organized by CODEBREAKERS at Government College of Engineering Kalahandi (GCEK), Bhawanipatna, Odisha.",
  ...
  club: {
    ...
    milestones: [
      ...
      {
        year: "2026",
        event: "INNOVEX '26 NATIONAL FEST",
