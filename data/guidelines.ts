...
export const STRUCTURED_RULES = [
  ...
  },
  {
    ...
    categoryLabel: "Team Identity",
    title: "Strict Team Name Restriction (No College Identity)",
    description: "The team name must not directly or indirectly reveal the team's college/institution. It must not contain the college name, acronym, abbreviation, short form, or any other identifiable reference.",
    tag: "STRICT DISQUALIFICATION",
    tagType: "danger" as const,
    severity: "danger" as const,
    keyTakeaway: "Zero tolerance. Do not use your college name or initials in your team name.",
  },
  {
    id: "rule-03",
    number: "03",
