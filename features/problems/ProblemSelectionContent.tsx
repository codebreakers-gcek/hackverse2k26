...
export function ProblemSelectionContent() {
  ...
  // State 3: User is authenticated, registered, and PS is published live!
  return (
      ...
      <div className="w-full max-w-7xl mx-auto px-3 xs:px-4 sm:px-6 lg:px-8 py-8 sm:py-14 space-y-8 sm:space-y-10 min-w-0">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b-3 border-black pb-4">
              <div className="space-y-1.5 min-w-0">
                <div className="flex flex-wrap items-center gap-1.5 sm:gap-2">
                  ...
                  <span
                    className={clsx(
                      "font-mono text-xs font-black uppercase px-2.5 py-0.5 border border-black shadow-neo-sm inline-flex items-center gap-1.5",
                  ...
                  >
                    ...
                    {userRoleInTeam === "LEADER" ? (
                      ...
                      <span className="inline-flex items-center gap-1">
                        <Users className="w-3 h-3 text-emerald-950 stroke-[2.5px]" />
                        <span>CO-HACKER</span>
                      </span>
                    )}
                  </span>
              ...
              <div className="flex items-center gap-2">
                <span
                  className={clsx(
                    ...
                    isLocked ? "bg-emerald-500" : selectedPsIds.length >= 1 ? "bg-emerald-500" : "bg-amber-500"
                  )}
                />
                {isLocked ? (
                  <span className="flex items-center gap-2">
                    <span className="bg-emerald-500 text-black px-2 py-0.5 border border-black font-black uppercase text-[10px]">
                      LOCKED &amp; CONFIRMED
                    </span>
        ...
        {isLocked ? (
          <div className="space-y-8 animate-in fade-in duration-200">
            ...
            <div className="border-4 border-black bg-white p-6 sm:p-8 shadow-neo space-y-4">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b-3 border-black pb-4">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 border-3 border-black bg-emerald-400 flex items-center justify-center shadow-neo-sm shrink-0">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-mono text-xs font-black uppercase px-2.5 py-0.5 bg-emerald-300 text-emerald-950 border border-black inline-flex items-center gap-1">
                ...
                <div className="flex flex-wrap items-center gap-2.5">
                  <Link
                    href="/register"
                    className="px-5 py-2.5 bg-neo-secondary hover:bg-neo-accent text-black border-3 border-black font-black text-xs uppercase tracking-wider shadow-neo-sm hover:shadow-none transition-all flex items-center gap-1.5"
                  >
                  ...
                  <Link
                    href="/problem-statements"
                    className="px-4 py-2.5 bg-white hover:bg-neutral-100 text-black border-2 border-black font-black text-xs uppercase tracking-wider shadow-neo-sm transition-all flex items-center gap-1.5"
                  >
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                {pref1Obj ? (
                  <div className="border-4 border-black bg-white p-6 sm:p-8 shadow-neo space-y-6 flex flex-col justify-between relative ring-4 ring-black">
                    <div className="space-y-4">
                      ...
                      <div className="flex flex-wrap items-center justify-between gap-2 border-b-2 border-black/10 pb-3">
                        ...
                        <span className="font-mono text-xs font-black uppercase px-3 py-1 bg-neo-secondary text-black border-2 border-black shadow-neo-sm inline-flex items-center gap-1.5">
                      ...
                      {/* Domain & Title */}
                      <div>
                        <div className="font-mono text-xs font-black uppercase tracking-wider text-black/60 flex items-center gap-1">
                      ...
                      <div className="p-4 bg-amber-50/70 border-2 border-black space-y-2">
                        <div className="font-mono text-[11px] font-black uppercase text-amber-950">
                          PROBLEM OVERVIEW:
                        </div>
                        ...
                        <ul className="space-y-1.5 text-xs font-bold text-black/85">
                          {pref1Obj.keyDeliverables.map((deliv, idx) => (
                            <li key={idx} className="flex items-start gap-2">
                              <span className="w-4 h-4 bg-black text-white font-mono text-[10px] flex items-center justify-center shrink-0 mt-0.5">
                                {idx + 1}
                              </span>
                              <span>{deliv}</span>
                            </li>
                      ...
                      {pref1Obj.relevantDatasets && pref1Obj.relevantDatasets.length > 0 && (
                        <div className="p-3 bg-cyan-50 border-2 border-black space-y-1">
                          <div className="font-mono text-[10px] font-black uppercase text-cyan-950">
                            RELEVANT DATASETS:
                          </div>
                    ...
                    <div className="pt-4 border-t-2 border-black/10 flex items-center justify-between gap-3">
                      <button
                        ...
                        className="w-full py-3 bg-white hover:bg-neutral-100 border-2 border-black font-black text-xs uppercase tracking-wider flex items-center justify-center gap-1.5 shadow-neo-sm hover:shadow-none transition-all cursor-pointer text-black"
                      >
                        <Eye className="w-4 h-4 stroke-[2.5px]" />
                  ...
                  <div className="border-4 border-black bg-neutral-100 p-8 text-center font-mono text-sm font-bold text-neutral-600">
                ...
                {pref2Obj ? (
                  <div className="border-4 border-black bg-white p-6 sm:p-8 shadow-neo space-y-6 flex flex-col justify-between relative ring-4 ring-black">
                    <div className="space-y-4">
                      ...
                      <div className="flex flex-wrap items-center justify-between gap-2 border-b-2 border-black/10 pb-3">
                        ...
                        <span className="font-mono text-xs font-black uppercase px-3 py-1 bg-neo-accent text-black border-2 border-black shadow-neo-sm inline-flex items-center gap-1.5">
                          <Sparkles className="w-3 h-3 stroke-[2.5px]" />
                      ...
                      {/* Paragraph Brief */}
                      <div className="p-4 bg-rose-50/70 border-2 border-black space-y-2">
                        <div className="font-mono text-[11px] font-black uppercase text-rose-950">
                          PROBLEM OVERVIEW:
                        </div>
                        <p className="text-xs sm:text-sm font-bold text-black/85 leading-relaxed">
                  ...
                  <div className="border-4 border-dashed border-black/40 bg-white p-8 flex flex-col items-center justify-center text-center space-y-3 shadow-neo-sm">
                    <span className="font-mono text-xs font-black uppercase px-2.5 py-0.5 bg-neutral-200 text-neutral-700 border border-black">
                      CHOICE #2 (OPTIONAL SECONDARY TRACK)
                    </span>
                    <h4 className="font-black text-lg uppercase text-neutral-600">
                      No 2nd Preference Selected
                    </h4>
                    <p className="text-xs font-bold text-neutral-500 max-w-sm leading-relaxed">
            ...
            <div className="border-4 border-black bg-emerald-100 p-5 sm:p-6 shadow-neo space-y-2 text-emerald-950">
              <div className="flex items-center gap-2 font-mono text-xs font-black uppercase text-emerald-950">
                <ShieldCheck className="w-5 h-5 text-emerald-800 stroke-[3px]" />
                  ...
                  >
                    ...
                    <div className="space-y-3">
                      <div className="flex flex-wrap items-center justify-between gap-2">
                        ...
                        {/* Selection Badges */}
                        {isPref1 && (
                          <span className="font-mono text-[11px] sm:text-xs font-black uppercase px-2.5 sm:px-3 py-1 bg-neo-secondary text-black border-2 border-black shadow-neo-sm inline-flex items-center gap-1">
                            <Sparkles className="w-3 h-3 stroke-[2.5px]" />
                            <span>PREF 1 (PRIMARY - MANDATORY)</span>
                          </span>
                        )}
                        {isPref2 && (
                          <span className="font-mono text-[11px] sm:text-xs font-black uppercase px-2.5 sm:px-3 py-1 bg-neo-accent text-black border-2 border-black shadow-neo-sm inline-flex items-center gap-1">
                            <Sparkles className="w-3 h-3 stroke-[2.5px]" />
            ...
            {showConfirmModal && (
              <div className="fixed inset-0 z-[99999] flex items-center justify-center p-3 sm:p-4 md:p-6 bg-black/80 backdrop-blur-xs overflow-hidden">
                ...
                <motion.div
                  ...
                  className="relative z-10 border-4 border-black bg-white max-w-xl w-full max-h-[min(90vh,740px)] flex flex-col shadow-neo-xl overflow-hidden my-auto"
                >
                  {/* Modal Header */}
                  <div className="flex items-center justify-between border-b-3 border-black p-4 sm:p-5 bg-neo-secondary shrink-0">
                    <div className="flex items-center gap-2 pr-2">
                      <ShieldCheck className="w-5 h-5 sm:w-6 sm:h-6 text-black stroke-[3px] shrink-0" />
                      <h3 className="font-black text-sm sm:text-base md:text-lg uppercase tracking-tight text-black line-clamp-1">
                    ...
                    <button
                      type="button"
                      onClick={() => !submitting && setShowConfirmModal(false)}
                      className="p-1 hover:bg-neutral-100 bg-white border-2 border-black font-black cursor-pointer shrink-0"
                  ...
                  <div className="p-4 sm:p-6 overflow-y-auto space-y-4 flex-1">
                    ...
                    {/* Team Info Box */}
                    <div className="p-3 bg-neo-bg border-2 border-black font-mono text-xs space-y-1">
                      <div>
                    ...
                    {/* Preferences Summary */}
                    <div className="space-y-3">
                      <div className="p-3.5 sm:p-4 bg-amber-50 border-3 border-black shadow-neo-sm space-y-1">
                        <span className="font-mono text-[10px] font-black uppercase px-2 py-0.5 bg-neo-secondary text-black border border-black inline-flex items-center gap-1">
                      ...
                      {pref2Obj ? (
                        <div className="p-3.5 sm:p-4 bg-rose-50 border-3 border-black shadow-neo-sm space-y-1">
                          <span className="font-mono text-[10px] font-black uppercase px-2 py-0.5 bg-neo-accent text-black border border-black inline-flex items-center gap-1">
                            <Sparkles className="w-2.5 h-2.5 stroke-[2.5px]" />
                  ...
                  <div className="p-4 sm:p-5 border-t-3 border-black bg-neutral-50 shrink-0 flex flex-col sm:flex-row items-center justify-end gap-3">
                    <button
                      type="button"
