...
export function EventFormatContent() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      >
                ...
                <div className="space-y-2.5">
                  {stage.points.map((pt, pIdx) => (
                    <motion.div
                      ...
                      className="flex items-start gap-3 p-2 rounded-none hover:bg-black/5 transition-colors"
                    >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {data.facilities.items.map((facility, idx) => {
              ...
              return (
                <motion.div
                  key={idx}
                  whileHover={shouldReduceMotion ? {} : { y: -2, boxShadow: "6px 6px 0px 0px #000" }}
                  transition={{ duration: 0.12 }}
        ...
        <motion.div
          variants={itemVariants}
          className="border-4 border-black bg-neo-secondary p-6 sm:p-8 shadow-neo flex flex-col sm:flex-row items-center justify-between gap-4"
        >
          <div>
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <Link
                href="/guidelines"
                className="px-5 py-2.5 bg-white text-black font-black text-xs uppercase border-3 border-black shadow-neo-sm hover:bg-neutral-100 transition-all inline-block"
              >
                RULES
              </Link>
            </motion.div>
