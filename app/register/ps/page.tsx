...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://hackverse.codebreakersgcek.tech/register/ps",
  },
  openGraph: {
    ...
    url: "https://hackverse.codebreakersgcek.tech/register/ps",
    images: [{ url: "/og-image.png", width: 1200, height: 630, type: "image/png", alt: "HACKVERSE '26 Problem Selection" }],
  },
  twitter: {
