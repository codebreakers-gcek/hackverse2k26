...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "CodeBreakers Technical Society",
    "Government College of Engineering Kalahandi",
    "GCEK Kalahandi history",
    "GCEK Bhawanipatna tech legacy",
    "CodeBreakers legacy",
    "premier technical club Kalahandi",
    "engineering legacy Odisha",
    "computer science society GCEK",
    "student developer ecosystem Odisha",
    "student hackathon community Odisha",
    "tech culture Kalahandi",
    "technical innovation Odisha",
    "CodeBreakers founders",
    "GCEK faculty mentors",
    "Odisha tech fest history",
    "flagship hackathon Odisha",
    "college coding society Odisha",
    "builder culture GCEK",
    "student developers Bhawanipatna",
    "technical club Bhawanipatna",
    "engineering students Kalahandi",
    "tech society GCEK",
    "Odisha student innovation hub",
    "GCEK CSE department",
    "Kalahandi engineering tech fest",
    "best tech club in Odisha",
    "top technical society Odisha",
    "student builders Odisha",
    "open source community Odisha",
    "developer collective GCEK",
    "hackathon organizing body GCEK",
    "CodeBreakers milestones",
    "CodeBreakers pillars",
    "tech community Bhawanipatna",
    "student led hackathon Odisha",
    "Central Western Odisha hackathon",
    "Kalahandi tech movement",
    "GCEK technical festival history",
    "engineering college innovators",
    "youth developer initiative Odisha",
    "peer to peer tech learning",
    "competitive programming GCEK",
    "software engineering society Odisha",
    "hardware innovation lab GCEK",
    "student mentorship community",
    "HACKVERSE mission",
    "HACKVERSE vision",
    "Odisha engineering excellence",
  ],
  alternates: {
